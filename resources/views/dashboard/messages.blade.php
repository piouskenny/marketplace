...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-slate-50 scroll-smooth">
    ...
    <body 
        ...
        x-init="setTimeout(() => pageLoading = false, 350); $nextTick(() => scrollToBottom())"
    >
        ...
        >
            ...
            <!-- Chat Viewport Skeleton -->
            <div class="flex-1 bg-white border border-slate-200/80 rounded-2xl flex flex-col overflow-hidden">
                <div class="p-4 border-b border-slate-100 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="h-3 w-24 bg-slate-100 rounded-md animate-pulse"></div>
                        </div>
                    </div>
                </div>
                <div class="flex-1 p-6 space-y-4">
                    <div class="h-12 w-64 bg-slate-100 rounded-2xl animate-pulse"></div>
                    <div class="h-12 w-80 bg-slate-200 rounded-2xl ml-auto animate-pulse"></div>
                    <div class="h-16 w-72 bg-slate-100 rounded-2xl animate-pulse"></div>
                </div>
        ...
        <div class="flex min-h-screen bg-slate-50">
            ...
            >
                ...
                <div class="p-4 border-t border-slate-200/80 shrink-0">
