<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full scroll-smooth" x-data="{ sidebarOpen: false, searchQuery: '', selectedCategory: 'All', profileModalOpen: false, notificationsOpen: false }">
    <head>
        <meta charset="utf-8">
