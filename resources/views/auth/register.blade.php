...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full scroll-smooth">
    <head>
        ...
        <title>Sign Up — {{ config('app.name', 'Skill Marketplace') }}</title>
    ...
    <body class="bg-white font-sans antialiased text-slate-900 min-h-full flex flex-col justify-between relative selection:bg-sky-500 selection:text-white">
        ...
        <main class="relative z-10 flex-1 flex flex-col justify-center items-center px-4 py-12">
            <div class="w-full max-w-md bg-white border border-slate-200/90 rounded-3xl p-7 sm:p-10 shadow-lg shadow-slate-900/5">
                ...
                <div class="mb-6">
                    <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50/80 rounded-full text-xs sm:text-sm font-semibold text-slate-800 transition-all shadow-xs group cursor-pointer">
                ...
                <form action="{{ url('/register') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex items-start gap-2.5 pb-2">
                        ...
                        <label for="terms" class="text-xs text-slate-600 leading-snug cursor-pointer">
                            Yes, I understand and agree to the <a href="#" class="text-sky-600 font-bold hover:underline">Skill Marketplace Terms of Service</a>, including the <a href="#" class="text-sky-600 font-bold hover:underline">User Agreement</a> and <a href="#" class="text-sky-600 font-bold hover:underline">Privacy Policy</a>.
                        </label>
                    </div>
